...
import org.reactome.server.graph.curator.domain.model.Publication;
import org.reactome.server.graph.curator.domain.result.SimpleEventProjection;
import org.reactome.server.graph.curator.service.PersonService;
...
@RestController
@Tag(name = "person", description = "Reactome Data: Person queries")
@RequestMapping("/data")
