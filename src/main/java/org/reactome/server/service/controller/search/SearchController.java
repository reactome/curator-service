...
import org.reactome.server.graph.curator.service.GeneralService;
...
class SearchController {
    ...
    public FireworksOccurrencesResult fireworksFlagging(@Parameter(example = "KNTC1", required = true) @RequestParam String query,
        ...
        FireworksOccurrencesResult rtn = null;
        // &&&& = searchManager.getFireworksOccurrencesResult(sp, query);
        if (rtn.isEmpty())
