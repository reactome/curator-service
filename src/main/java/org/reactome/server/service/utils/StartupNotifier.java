...
public class StartupNotifier extends Thread {
    ...
    private static final String PROJECT = "CuratorAPI";
    ...
    private String getWho() throws IOException, InterruptedException {
        ...
        return process.waitFor() == 0 ? IOUtils.toString(process.getInputStream(),  StandardCharsets.UTF_8) : "<<Couldn't execute 'who' command>>";
    }
}
